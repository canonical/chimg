...
from chimg.image_customizer import customize_image_entry_point
...
def _parser():
    ...
    p_chrootfs.add_argument(
        ...
        action="store_true",
        help=(
            "Generate a Software Bill of Materials (SBOM) for the output files. "
            "If true, --output-files-name must be given."
        ),
    )
    p_chrootfs.add_argument(
        "--overwrite",
